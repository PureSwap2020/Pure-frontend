...
import { Heading, Text, Flex, ChevronRightIcon } from '@pureswap-libs/uikit'
  ...
  return (
    <>
      ...
      <Text as="p">
        {TranslateString(
          999,
          'Pancake Collectibles are special ERC-721 NFTs that can be used on the PureSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(

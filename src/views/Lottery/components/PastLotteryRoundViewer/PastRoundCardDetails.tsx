...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@pureswap-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} PURE`)}

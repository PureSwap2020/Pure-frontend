  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to PureSwap.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using PURE-HT LP tokens, which means you need to stake equal amounts of PURE and BNB in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
            ...
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, PureSwap burns the PURE.')}
              <br />
